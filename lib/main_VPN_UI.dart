...
import 'package:projects_gallery/vpn_ui/utils.dart';
import 'vpn_ui/custom_clipper.dart';
    ...
    return Scaffold(
        ...
        body: ListView(
          children: <Widget>[
            ...
            locationCard(
                'Random Location', Colors.transparent, kenyaFlagUrl, 'Kenya'),

            SizedBox(height: 20),

            locationCard(
                'Select Location', Colors.indigo[100], ugandaFlagUrl, 'Uganda'),
          ],
        ));
  }
}
